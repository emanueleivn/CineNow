...
<head>
    ...
    <style>
        ...
        header { background: #121212; color: #fff; padding: 15px; display: flex; align-items: center; }
        ...
        input[type="text"], input[type="password"], .btn { width: 100%; padding: 10px; margin: 10px 0; border: 1px solid #333333; border-radius: 5px; box-sizing: border-box; background-color: #333333; color: #ffffff; }
...
<div class="content">
    ...
    <p>Non sei registrato? <a href="<%=request.getContextPath() %>/registrazione" style="color: #ff3b30;">Iscriviti ora</a>.</p>
</div>
